...
import { StyleSheet, Text, View,Image,TouchableOpacity, ImageBackground,Dimensions,Pressable,ActivityIndicator,Alert} from 'react-native';
...
function checkPassword(firstpassword,secondpassword) {
  ...
  async function createAccount() {
    ...
    Alert.alert(
      ...
      'Kindly fill all the details in the Profile Screen!',
  );
